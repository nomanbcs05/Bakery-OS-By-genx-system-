...
const mainNav = [
  ...
  { title: 'Customer Ledger', url: '/customer-ledger', icon: History },
...
export function AppSidebar() {
  ...
  const filteredMainNav = mainNav.filter(item => {
    ...
    if (isRole(['production_manager'])) return ['Raw Materials', 'Departments', 'Purchases', 'Production', 'Production History', 'Recipes (BOM)', 'Production Stock', 'Dispatch', 'Customer Ledger', 'Dispatch History', 'Advance Orders'].includes(item.title);
    if (isRole(['accountant'])) return ['Dashboard', 'Raw Materials', 'Departments', 'Purchases', 'Customer Ledger', 'Dispatch History'].includes(item.title);
